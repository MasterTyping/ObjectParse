...
public class ModelTextureLoader : MonoBehaviour {

    static public Texture2D ScaleTexture(ref Texture2D source, int targetWidth, int targetHeight)
    {
        Debug.Log("Scale Texture");
    ...
    public static Texture2D LoadTexture(string fn, bool normalMap = false)
    {
        ...
        if (ext == ".png" || ext == ".jpg")
        {
            ...
            //t2d = ScaleTexture(t2d, 256, 256);
            if (normalMap)
                SetNormalMap(ref t2d);           
            t2d.name = Path.GetFileName(fn);
            return t2d;
        }
        else if (ext == ".dds")
        {
            ...
            returnTex.name = Path.GetFileName(fn);
            return returnTex; 
        }
        else if (ext == ".tga")
        {
